...
{
    console.log("je suis dans document ready")
...
//     //DEFINITION DE VARIABLE
    ...
    for (let i = 0; i < characters.length; i++){
        ...
        if(i < characters.length/2){
             $('.content_1').append('<div class="box box1" name="' + character + '"><img src="../assets/img/original/'+ character +'.jpg" alt="..." class="img-thumbnail picture"><img src="../assets/img/hide/riddler.jpg" class="img-thumbnail riddler"></div>');

             $('.content_3').append('<div class="box box3" name="' + character + '"><img src="../assets/img/original/'+ character +'.jpg" alt="..." class="img-thumbnail picture"><img src="../assets/img/hide/riddler.jpg" class="img-thumbnail riddler"></div>');
       ...
       if(i>=characters.length/2 && i<characters.length){
            ...
            $('.content_2').append('<div class="box box2" name="'+character+'"><img src="../assets/img/original/'+character+'.jpg" alt="..." class="img-thumbnail picture"><img src="../assets/img/hide/riddler.jpg" class="img-thumbnail riddler"></div>');

            $('.content_4').append('<div class="box box4" name="'+character+'"><img src="../assets/img/original/'+character+'.jpg" alt="..." class="img-thumbnail picture"><img src="../assets/img/hide/riddler.jpg" class="img-thumbnail riddler"></div>');
    ...
    function click_authorized(double,score){
        if( double.length===2 && double[0]===double[1] ){
